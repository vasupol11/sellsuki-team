  ...
  <div>
    <ul id="hexGrid">
      ...
      <li class="hex">
        <div class="hexIn">
          <a class="hexLink hex-bg-icon" href="#">
            <h2 class="menu menu-2">Pongsatorn</h2>
          </a>
        </div>
      </li>
      <li class="hex">
      ...
      <li class="hex">
        <div class="hexIn">
          <a class="hexLink hex-bg-logo" href="#">
            <img class="logo" src="https://scontent.fbkk5-6.fna.fbcdn.net/v/t1.0-9/14705858_10207343070150864_8182941307407122671_n.jpg?oh=4c23eeb80b7013fc6392c095e6f84b21&oe=5A7F6DB1"/>
          </a>
        </div>
      </li>
      <li class="hex">
      ...
      <li class="hex">
        <div class="hexIn">
          <a class="hexLink hex-bg-icon" href="#">
            <h2 class="menu menu-3">I Love Vue JS</h2>
          </a>
        </div>
      </li>
    </ul>
...
@media (min-width:1201px) { /* <- 5-4  hexagons per row */
  ...
  .hex:nth-child(5n+1){ /* first hexagon of even rows */
    margin-left:16%;  /* = width of .hex / 2  to indent even rows */
  }
}
